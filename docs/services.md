...
Write the `provider` / `offering` / `listing` files yourself (by hand, exported
from the dashboard, or generated by a [populator](service-templates.md#3-your-own-service-templates--usvc_seller-data-populate)),
then upload:
