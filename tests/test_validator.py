...
from unitysvc_sellers.validator import DataValidator


@pytest.fixture
def schema_dir():
    """Get the schema directory path — schemas live in unitysvc-core."""
    import unitysvc_core

    return Path(unitysvc_core.__file__).parent / "schema"
