...
T = TypeVar("T", bound="TeamListItemPublic")



@_attrs_define
class TeamListItemPublic:
    """ Team summary for list view (includes plan info).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        team_list_item_public.additional_properties = d
        return team_list_item_public
