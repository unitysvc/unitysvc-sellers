...
if TYPE_CHECKING:
  from ..models.service_offering_data_upstream_access_config_type_0_additional_property import ServiceOfferingDataUpstreamAccessConfigType0AdditionalProperty
...
class ServiceOfferingDataUpstreamAccessConfigType0:
    ...
    additional_properties: dict[str, ServiceOfferingDataUpstreamAccessConfigType0AdditionalProperty] = _attrs_field(init=False, factory=dict)
