...
class ListPriceUpdate:
    ...
    set_: ListPriceUpdateSetType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.list_price_update_set_type_0 import ListPriceUpdateSetType0
        d = dict(src_dict)
        def _parse_set_(data: object) -> ListPriceUpdateSetType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(ListPriceUpdateSetType0 | None | Unset, data)
