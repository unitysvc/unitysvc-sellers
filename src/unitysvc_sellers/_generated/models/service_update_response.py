...
if TYPE_CHECKING:
    from ..models.service_update_response_price_type_0 import ServiceUpdateResponsePriceType0
...
class ServiceUpdateResponse:
    ...
    price: None | ServiceUpdateResponsePriceType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.price, Unset):
            price = UNSET
        elif isinstance(self.price, ServiceUpdateResponsePriceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_price(data: object) -> None | ServiceUpdateResponsePriceType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                price_type_0 = ServiceUpdateResponsePriceType0.from_dict(data)

                return price_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ServiceUpdateResponsePriceType0 | Unset, data)
