...
if TYPE_CHECKING:
  from ..models.admin_promotion_update_pricing_type_0 import AdminPromotionUpdatePricingType0





T = TypeVar("T", bound="AdminPromotionUpdate")



@_attrs_define
class AdminPromotionUpdate:
    """ Schema for updating a platform promotion.
    ...
    pricing: AdminPromotionUpdatePricingType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.pricing, Unset):
            pricing = UNSET
        elif isinstance(self.pricing, AdminPromotionUpdatePricingType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pricing(data: object) -> AdminPromotionUpdatePricingType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                pricing_type_0 = AdminPromotionUpdatePricingType0.from_dict(data)
                ...
                pass
            return cast(AdminPromotionUpdatePricingType0 | None | Unset, data)
        ...
        admin_promotion_update.additional_properties = d
        return admin_promotion_update
