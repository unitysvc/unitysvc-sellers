...
if TYPE_CHECKING:
  from ..models.admin_promotion_create_pricing import AdminPromotionCreatePricing
  from ..models.admin_promotion_create_scope_type_0 import AdminPromotionCreateScopeType0





T = TypeVar("T", bound="AdminPromotionCreate")



@_attrs_define
class AdminPromotionCreate:
    """ Schema for admins creating a platform promotion.

    Inherits all fields from PromotionData (unitysvc-core).
    The backend auto-sets source=platform_code, and decomposes scope
    into internal fields during ingestion.

     """

    name: str
    """ Display name of the promotion (unique per seller) """
    pricing: AdminPromotionCreatePricing
    """ Pricing specification (e.g., multiply, constant, add) """
    description: None | str | Unset = UNSET
    """ Human-readable description """
    scope: AdminPromotionCreateScopeType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.scope, Unset):
            scope = UNSET
        elif isinstance(self.scope, AdminPromotionCreateScopeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing = AdminPromotionCreatePricing.from_dict(d.pop("pricing"))
        ...
        def _parse_scope(data: object) -> AdminPromotionCreateScopeType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                scope_type_0 = AdminPromotionCreateScopeType0.from_dict(data)
                ...
                pass
            return cast(AdminPromotionCreateScopeType0 | None | Unset, data)
        ...
        admin_promotion_create.additional_properties = d
        return admin_promotion_create
