...
T = TypeVar("T", bound="RoutingVarsUpdate")



@_attrs_define
class RoutingVarsUpdate:
    """ Request body for updating routing_vars on an active service.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_set_(data: object) -> Union['RoutingVarsUpdateSetType0', None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                set_type_0 = RoutingVarsUpdateSetType0.from_dict(data)
        ...
        routing_vars_update = cls(
            set_=set_,
            remove=remove,
        )


        routing_vars_update.additional_properties = d
        return routing_vars_update
