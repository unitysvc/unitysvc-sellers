...
class ServiceOfferingDataDocumentsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_offering_data_documents_type_0.additional_properties = additional_properties
        return service_offering_data_documents_type_0

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> ServiceOfferingDataDocumentsType0AdditionalProperty:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: ServiceOfferingDataDocumentsType0AdditionalProperty) -> None:
