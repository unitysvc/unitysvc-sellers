...
T = TypeVar("T", bound="SellerCreate")
...
class SellerCreate:
    ...
    The account_manager field should contain a username (email prefix before @)
    or full email address of the user who will manage this seller account.
    The system will look up the user and set the account_manager_id automatically.
    ...
    account_manager: str
    """ Username or email of the user who will manage this seller account """
    ...
    """ User ID creating this seller (set by API) """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_manager = d.pop("account_manager")
        ...
        seller_create.additional_properties = d
