...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/seller/service-groups/{group_id}/refresh".format(group_id=quote(str(group_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Refresh Seller Group

     Refresh group memberships based on membership rules.
